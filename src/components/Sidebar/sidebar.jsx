...
//   const academicData = mystudentDetails && mystudentDetails.student[0].academic_data ? mystudentDetails && mystudentDetails.student[0].academic_data.course_adviser.staff.user.full_name : "You have not been assigned level adviser" ;
...
//           <p className={styles.colorNotify}>
//              { mystudentDetails && mystudentDetails.student[0].notices? mystudentDetails && mystudentDetails.student[0].notices.length : "0"}
//           </p>
//         </div>
//       </div>
...
//           name={academicData } 
//           header={"Designated Course Adviser"}
//         /> }
...
//         <div className={styles.board}> <NotificationCard/> </div>
//       </div>
//     </div>
//   );
// };
